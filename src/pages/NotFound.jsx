...
const NotFound = () => {
	return (
		<main className='h-screen absolute top-0 left-0 z-10 w-full flex flex-col justify-center items-center bg-[#1A2238]'>
			...
			<button className='mt-5'>
				<Link
					to='/'
					className='relative inline-block text-sm font-medium text-primary group focus:outline-none'
				>
